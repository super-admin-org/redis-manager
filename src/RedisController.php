...
class RedisController extends BaseController
{
    ...
    public function index()
    {
        return Admin::content(function (Content $content) {
            ...
            $content->body(view('super-admin-redis-manager::index', $vars));
        });
    }
    ...
    public function edit(Request $request)
    {
        return Admin::content(function (Content $content) use ($request) {
            ...
            if (empty($this->data)) {
                $view = 'super-admin-redis-manager::edit.nil';
            } else {
                $view = 'super-admin-redis-manager::form';
            }
    ...
    public function create(Request $request)
    {
        return Admin::content(function (Content $content) use ($request) {
            ...
            //$content->body(view($view, $vars));
            $content->body(view('super-admin-redis-manager::form', $vars));
        });
    }
    ...
    public function console(Request $request)
    {
        return Admin::content(function (Content $content) use ($request) {
            ...
            $view = 'super-admin-redis-manager::console';
